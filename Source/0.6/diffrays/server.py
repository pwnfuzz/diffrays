...
def create_app(db_path: str, log_file: Optional[str] = None, host: str = "127.0.0.1", port: int = 5050):
    ...
    def index():
        ...
        try:
            ...
            app.logger_obj.info(f"Found {total_functions} functions across categories")
        except Exception as e:
        ...
        return render_template(
            "index.html",
            subtitle=f"functions categorized by modification level - {Path(app.config['DB_PATH']).name}",
